...
GCC_PATH="/home/whz/.vscode-server/data/User/globalStorage/bmd.stm32-for-vscode/@xpack-dev-tools/arm-none-eabi-gcc/12.2.1-1.2.1/.content/bin
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"/mnt/d/openocd/bin/openocd.exe" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"/mnt/d/openocd/bin/openocd.exe" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
